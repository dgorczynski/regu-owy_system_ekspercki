...
class JobFinder implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   JobFinder()
     {  
      ...
      JFrame jfrm = new JFrame(autoResources.getString("JobFinder"));  
